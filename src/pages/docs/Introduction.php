...
function Introduction()
{
    return (
        <DocPage title="What is PHPX" description="React-like components in PHP, compiled to WebAssembly.">
            ...
            <Callout type="tip" title="The headline feature">
                The fiber engine patches only the DOM nodes that change, so inputs keep their focus and
                caret across re-renders. The live examples throughout these docs let you feel it.
            </Callout>
