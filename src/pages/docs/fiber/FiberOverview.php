...
{
    return (
        <DocPage title="The Reconciler" description="Surgical DOM updates that preserve focus.">
            <p>
                At the heart of PHPX is a Preact-class reconciler. It keeps a persistent tree of nodes
